...
class AdvancedConv2DModelV3(nn.Module):
    def __init__(self, name, num_classes=7, dtype=torch.float32):
        super(AdvancedConv2DModelV3, self).__init__()

        self.name = 'AdvancedConv2DModelV3' + name
        self.dtype = dtype
        ...
        self.block1 = ResidualBlock(64, 64).to(dtype=self.dtype)
