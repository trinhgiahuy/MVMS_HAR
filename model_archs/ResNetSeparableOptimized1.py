...
class ResNetSeparableOptimized1(nn.Module):
    def __init__(self, name, num_classes=6, dtype=torch.float32):
        super(ResNetSeparableOptimized1, self).__init__()
        self.name = "ResNetSeparableOptimized1" + name
        ...
        self.attention = MultiHeadSelfAttention(512, num_heads=4)
